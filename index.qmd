...
[Download and install](user-guide/installation.qmd), then follow the [two-case walkthrough](user-guide/tutorial.qmd) using the official illustrative workbook. Windows and Mac distributions are being prepared for the first downloadable release.
